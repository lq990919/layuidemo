...
public class VerifyCodeUtil {
    ...
    public static String outputImage(int w, int h, String code) throws IOException {
        ...
        String base64Img = String.format(BASE64_IMAGE, Base64Util.encode(String.valueOf(baos.toByteArray())));
        return base64Img;
    }
    ...
    public static void main(String[] args) throws IOException {
        File dir = new File("F:/upload/verifyCode");
        int w = 200, h = 80;
        for (int i = 0; i < 50; i++) {
